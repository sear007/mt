...
function submitRequest(){
  ...
  var _holidays = {
    ...
    function renderCalendar (){
        ...
        let holidays = '';
        moment.locale('km');
        document.querySelector(".title").innerHTML = `<span class="text-muted">២.១ តារាងស្រង់វត្តមាន ប្រចាំខែ </span> <strong>${moment.months(date.getMonth())}</strong> <strong>${k_number(date.getFullYear())}</strong>` ;
